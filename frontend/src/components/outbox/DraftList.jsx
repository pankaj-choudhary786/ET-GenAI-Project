          ...
          return (
            ...
            >
              ...
              <div className="flex gap-3 mb-2">
                <Avatar name={draft.contactName} size="sm" className="mt-0.5" />
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-2">
                    <h4 className="font-semibold text-slate-900 truncate">{draft.contactName}</h4>
                    <span className="text-xs text-slate-400 whitespace-nowrap">{draft.time}</span>
                  </div>
                  <p className="text-sm font-medium text-slate-500 truncate">{draft.company}</p>
                </div>
              </div>
